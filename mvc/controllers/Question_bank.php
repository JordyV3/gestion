...
class Question_bank extends Admin_Controller {
    ...
    public function unique_group() {
        if($this->input->post('group') == 0) {
            $this->form_validation->set_message("unique_group", "El campo %s es obligatorio");
            return FALSE;
        }
        return TRUE;    
    }
    ...
    public function unique_level() {
        if($this->input->post('level') == 0) {
            $this->form_validation->set_message("unique_level", "El campo %s es obligatorio");
            return FALSE;
        }
        return TRUE;
    }
    ...
    public function unique_total_option() {
        if($this->input->post('totalOption') == 0) {
            $this->form_validation->set_message("unique_total_option", "El campo %s es obligatorio");
            return FALSE;
        }
        return TRUE;
    }
    ...
    public function unique_answer() {
        if($this->input->post('type') == 3) {
            ...
            if($f != 1) {
                $this->form_validation->set_message("unique_answer", "Por favor, seleccione al menos una respuesta");
                return FALSE;
            }
            return TRUE;
        } else {
