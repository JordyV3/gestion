...
class Grade extends Admin_Controller {
	...
	public function unique_gradefrom() {
		...
		if((int)$id) {
			if($this->input->post("gradefrom") != '') {
				...
				$this->form_validation->set_message("unique_gradefrom", "El campo %s es obligatorio.");
				return FALSE;
			}
		} else {
			if($this->input->post("gradefrom") != '') {
	...
	public function unique_gradeupto() {
		...
		if((int)$id) {
			if($this->input->post("gradeupto") != '') {
				...
				$this->form_validation->set_message("unique_gradeupto", "El campo %s es obligatorio.");
				return FALSE;
			}
		} else {
			if($this->input->post("gradeupto") != '') {
	...
	public function gradefrom_grater() {
		if($this->input->post("gradefrom") != '' && $this->input->post("gradeupto") != '') {
			if($this->input->post("gradefrom") > $this->input->post("gradeupto")) {
				$this->form_validation->set_message("gradefrom_grater", "El campo %s no puede ser más grande para marcar hasta el campo.");
				return FALSE;
			}
		}
		return TRUE;
	...
	public function gradeupto_grater() {
		if($this->input->post("gradefrom") != '' && $this->input->post("gradeupto") != '') {
			if($this->input->post("gradefrom") > $this->input->post("gradeupto")) {
				$this->form_validation->set_message("gradeupto_grater", "El campo %s no puede ser el más pequeño para marcar desde el campo.");
				return FALSE;
			}
		}
		return TRUE;
