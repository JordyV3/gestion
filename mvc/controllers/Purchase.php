...
class Purchase extends Admin_Controller {
    ...
    public function unique_asset() {
        if($this->input->post('assetID') == 0) {
            $this->form_validation->set_message('unique_asset', 'El campo %s es obligatorio.');
            return FALSE;
        }
        return TRUE;
    }
    ...
    public function unique_vendor() {
        if($this->input->post('vendorID') == 0) {
            $this->form_validation->set_message('unique_vendor', 'El campo %s es obligatorio.');
            return FALSE;
        }
        return TRUE;
    }
    ...
    public function unique_purchase_by() {
        if($this->input->post('purchased_by') == 0) {
            $this->form_validation->set_message('unique_purchase_by', 'El campo %s es obligatorio.');
            return FALSE;
        }
        return TRUE;
    }
    ...
    public function unique_unit() {
        if($this->input->post('unit') == 0) {
            $this->form_validation->set_message('unique_unit', 'El campo %s es obligatorio.');
            return FALSE;
        }
        return TRUE;
    }
