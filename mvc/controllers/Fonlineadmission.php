        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if($frontendSetting->online_admission_status == 1) {
                    ...
                    $retArray['message'] = 'La admisión se ha cerrado';
                    echo json_encode($retArray);
                }
            }
        } else {
    ...
    public function check_admissionID() {
        if($this->input->post('admissionID') != '') {
            ...
            if(count($admissions)) {
                ...
                $this->form_validation->set_message("check_admissionID", "La ID de Admisión no existe.");
                return FALSE;
            }
        } else {
            return TRUE;
    ...
    public function check_phone() {
        if($this->input->post('phone') != '') {
            ...
            if(count($admissions)) {
                ...
                $this->form_validation->set_message("check_phone", "El número de teléfono no existe.");
                return FALSE;
            }
        } else {
            return TRUE;
