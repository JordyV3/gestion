	...
	public function unique_cover_photo() {
		...
		if($_FILES["cover_photo"]['name'] !="") {
            ...
            if(count($explode) >= 2) {
				...
				$this->form_validation->set_message("unique_cover_photo", "Archivo inválido");
	     		return FALSE;
			}
		} else {
			if($this->uri->segment('2') == 'edit') {
				...
				$this->form_validation->set_message("unique_cover_photo", "El archivo es requerido.");
				return FALSE;
			}
		}
	}
	...
	public function unique_file() {
		...
		if($_FILES["file"]['name'] !="") {
            ...
            if(count($explode) >= 2) {
				...
				$this->form_validation->set_message("unique_file", "Archivo inválido");
	     		return FALSE;
			}
		} else {
			if($this->uri->segment('2') == 'edit') {
				...
				$this->form_validation->set_message("unique_file", "El archivo es requerido.");
				return FALSE;
			}
		}
	}
